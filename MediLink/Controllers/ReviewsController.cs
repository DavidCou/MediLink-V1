...
namespace MediLink.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddReview(PractitionerReviewViewModel viewModel)
        {
            ClaimsPrincipal claimuser = HttpContext.User;
            string userName = "";
            ...
            viewModel.review.PatientId = patient.Id;

            _mediLinkContext.PractitionerReviews.Add(viewModel.review);
            await _mediLinkContext.SaveChangesAsync();

            TempData["Success"] = "Your review has been added.";

            return RedirectToAction("UnreviewedPractitioners", "Reviews");
        }

        [HttpPost]
        public async Task<IActionResult> EditReview(PractitionerReviewViewModel viewModel)
        {
            ClaimsPrincipal claimuser = HttpContext.User;
            string userName = "";
            ...
            _mediLinkContext.PractitionerReviews.Update(viewModel.review);
            await _mediLinkContext.SaveChangesAsync();

            TempData["Success"] = "Your review has been updated.";

            return RedirectToAction("ReviewedPractitioners", "Reviews");
        }
